...
import it.micheledallerive.covid_italia.notification.MyReceiver;
...
public class Utils {
    ...
    public static boolean isFirstTime(){
        if(!Preferences.getSharedPreferences().contains("firstTime")) {
            Preferences.getEditor().putBoolean("firstTime", true).commit();
            return true;
        }
        return false;
    }
    ...
    public static int getTransparentColor(int color, double alpha){
        int a = Color.alpha(color);
    ...
    public static double round(double value, int places) {
        Locale l = getApplicationContext().getResources().getConfiguration().getLocales().get(0);
